...
import ProfileCardHead from '../components/Logistics/ProfileCardHead'
import CommitteeMain from '../components/Logistics/CommitteeMain'
import ProfileCardCore from '../components/Logistics/ProfileCardCore'
const Committee = () => {
  return (
