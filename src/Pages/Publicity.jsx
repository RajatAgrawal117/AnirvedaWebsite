...
import ProfileCardHead from '../components/Publicity/ProfileCardHead'
import CommitteeMain from '../components/Publicity/CommitteeMain'
// import ProfileCardCore from '../components/SM/ProfileCardCore'
const Committee = () => {
  return (
    <div className='bg-black font-Lato h-screen'>
