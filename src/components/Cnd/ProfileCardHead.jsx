...
import img1 from "../Committee/images/diya.jpg"
import img2 from "../Committee/images/rutvi.png"
  ...
  const people = [
    {
      ...
      name: "Diya Desai",
      //   position: "President",
      linkedIn: "https://www.linkedin.com/in/diya-desai-110a7320b/",
    },
    {
      id: 2,
      name: "Rutvi Shah",
      //   position: "Vice President",
      linkedIn: "https://www.linkedin.com/in/rutvi-shah-702922225/",
    },
    // {
    //   id: 3,
    //   name: "Dhaivat Jani",
  ...
  return (
    <div className=" bg-black pb-8 btwnMdAndLg:pt-10 xl:pl-2 xl:pr-2">
      <div className=" relative mt-8 flex w-full items-center justify-center sm:p-10 md:mt-0 md:px-5 lg:px-8">
        ...
        <div className="hidden  md:gap-5 lg:mx-auto lg:flex lg:h-full lg:w-full lg:gap-8 xl:gap-2 xl:justify-center xl:w-1/2">
          {studList}
        </div>
