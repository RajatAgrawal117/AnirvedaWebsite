...
import img1 from "../Committee/images/ritika.jpg"
import img2 from "../Committee/images/dinky.jpg"
...
export default function ProfileCardExec() {
     const people = [
       ...
       },
       {
         id: 2,
         name: "Dinky Unadkat",
         linkedIn: "https://www.linkedin.com/in/dinky-unadkat-032696228/",
       },
     ]
          ...
          return (
            <div className=" bg-black pb-8 btwnMdAndLg:pt-10 xl:pl-2 xl:pr-2">
              <div className=" relative mt-8 flex w-full items-center justify-center sm:p-10 md:mt-0 md:px-5 lg:px-8">
                ...
                <div className="xl:w-1/2  hidden md:gap-5 lg:mx-auto lg:flex lg:h-full lg:w-full lg:gap-8 xl:justify-center xl:gap-2">
                  {studList}
                </div>
